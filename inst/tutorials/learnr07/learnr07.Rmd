...
## Data
#load("df_learnr07_ep_elections.rda") # for local testing
data(df_learnr07_ep_elections)
```
...
```{r encode, echo=FALSE}
learnrhash::encoder_ui(default_ui(url = "https://ilias.uni-mannheim.de/goto.php?target=svy_1125406&client_id=ILIAS"))
```
